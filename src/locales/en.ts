      ...
      items: [
        {
          ...
          body: 'Run full pre-hire medical checks for new joiners across multiple clinics in one coordinated flow. Upload employee lists, assign packages by role or site, and let HR track every candidate from booking through clearance — without chasing clinics by phone or email.',
          outcome: 'Onboard new hires with coordinated clinic bookings',
          bullets: [
            'Bulk book across certified clinics',
            'Track each candidate in real time',
            'Download PDF reports when cleared',
            'Automated reminders before appointment dates',
          ],
          trustLabel: 'Fit for Service',
        ...
        },
        {
          ...
          body: 'Iqama medical screenings for your entire workforce, recognised by the Ministry of Health across KSA. Schedule exams by department, monitor expiry windows, and keep compliance dashboards green before renewals become urgent.',
          outcome: 'Keep iqama medical compliance current at scale',
          bullets: [
            'MOH-recognised residency screenings',
            'Assign exams by employee or batch',
            'Status updates in your dashboard',
            'Expiry alerts 30 and 60 days ahead',
          ],
          trustLabel: 'MOH-aligned',
        ...
        },
        {
          ...
          body: 'Renew health certificates for food handlers, public-service workers, and licensees in a single batch. Filter staff by municipality zone, split bookings across nearby centres, and export signed PDFs ready for inspection visits.',
          outcome: 'Renew municipal health certs in one batch',
          bullets: [
            'Food handler & public-service renewals',
            'Batch uploads for large teams',
            'Ready-to-share PDF certificates',
            'Zone-based clinic routing for faster slots',
          ],
          trustLabel: 'Batch renewals',
