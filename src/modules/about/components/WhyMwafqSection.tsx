      ...
      <div className="mx-auto max-w-[1320px]">
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-[70px]">
          <div>
            ...
            <p className="text-[16px] leading-[1.7] text-[#6b7196]">{content.body}</p>
          </div>
          ...
          <ul className="flex flex-col gap-4">
            {content.items.map((item, index) => (
              ...
              >
                <span className="inline-flex h-[42px] w-[42px] flex-shrink-0 items-center justify-center rounded-full border-2 border-[#00a8f1] bg-[#e8f6fd] text-[15px] font-extrabold text-[#00a8f1]">
                  {index + 1}
                </span>
                <div>
