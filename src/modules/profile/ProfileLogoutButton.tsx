...
const signOutStyles =
  'h-auto w-full min-h-0 justify-start gap-3 rounded-[18px] border-0 bg-transparent px-4 py-[14px] text-left text-[14.5px] font-semibold text-[#742f88] shadow-none ring-0 hover:bg-[#f3e9f7] hover:text-[#5e2570] focus-visible:ring-2 focus-visible:ring-[#742f88]/30';
