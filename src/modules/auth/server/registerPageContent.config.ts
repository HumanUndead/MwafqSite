...
const parsedRegisterPageCategoryId = Number(
  process.env.MWAFQ_REGISTER_PAGE_CATEGORY_ID ?? 137
);

export const REGISTER_PAGE_CONTENT_API_BASE_URL = MWAFQ_API_BASE_URL;
export const REGISTER_PAGE_CONTENT_ROOT_CATEGORY_ID = Number.isFinite(
