...
import { ArrowIcon, SearchIcon, CarIcon, BuildingIcon, CertificateIcon, BriefcaseIcon } from './Icons'
...
export function HeroSection({ content, isRtl }: Props) {
  return (
    <section
      id="home"
      ...
      <div className="relative mx-auto grid max-w-[1320px] items-center gap-[60px] lg:grid-cols-[1.05fr_1fr]">
        ...
        <div className="-translate-y-10">
          ...
          <div className="mb-11 flex flex-wrap gap-3.5">
            <a href="#booking" className={buttonVariants({ variant: 'brand', size: 'hero', shape: 'pill' })}>
              {content.primaryCta}
              <ArrowIcon />
            </a>
            <a href="#app" className={buttonVariants({ variant: 'brandOutline', size: 'hero', shape: 'pill' })}>
