          ...
          {content.items.map((course, index) => (
            ...
            >
              ...
              <div className="mb-[18px] flex items-center gap-3.5">
                ...
                <span className={`rounded-full border-2 px-3 py-[5px] text-[11px] font-bold uppercase tracking-[0.5px] ${index === 2 ? 'border-transparent bg-[rgba(217,116,60,0.14)] text-[#a65528]' : 'border-[#00a8f1] bg-white text-[#00a8f1]'}`}>
                  {course.meta}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between border-t-2 border-[#e5e7f0] pt-4">
                <div className="flex items-center gap-1.5 text-[13px] font-bold text-[#1e2364]">
                  <StarIcon />
                  {course.ratingValue}
                  <span className="font-medium text-[#6b7196]">({course.ratingCount})</span>
                </div>
