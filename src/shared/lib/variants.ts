  ...
  'inline-flex items-center justify-center gap-2 font-semibold transition focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        ghost:        'text-gray-700 hover:bg-gray-100 focus:ring-2 focus:ring-gray-400 focus:ring-offset-2',
        danger:       'bg-red-600 text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2',
        brand:        'bg-[#1e2364] text-white hover:bg-[#233567] focus:ring-2 focus:ring-[#1e2364] focus:ring-offset-2',
        brandOutline: 'border-2 border-[#1e2364] bg-white text-[#1e2364] hover:-translate-y-0.5',
        brandGhost:   'border-2 border-white bg-transparent text-white hover:bg-white hover:text-[#1e2364]',
        brandInverse: 'border-2 border-white bg-white text-[#1e2364] hover:bg-[#00a8f1] hover:border-[#00a8f1] hover:text-white',
      },
      size: {
...
export const toastVariants = cva('rounded-lg border px-4 py-3 text-sm font-medium shadow-md', {
  variants: {
    type: {
...
export const modalVariants = cva('relative z-10 w-full rounded-2xl bg-white shadow-xl', {
  variants: {
    size: {
      sm: 'max-w-sm p-5',
      md: 'max-w-md p-6',
