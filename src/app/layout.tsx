...
const lamaSans = localFont({
  src: [
    { path: '../../public/fonts/LamaSans-Regular.otf', weight: '400', style: 'normal' },
    { path: '../../public/fonts/LamaSans-SemiBold.otf', weight: '600', style: 'normal' },
    { path: '../../public/fonts/LamaSans-Bold.otf', weight: '700', style: 'normal' },
  ],
